...
public class WebConfiguration extends WebMvcConfigurerAdapter {
	...
	//HttpMessageConverter as @Bean is the quickest and simplest way of adding a custom converter to the application.
	/*@Bean
	...
	configure other things such as interceptors, then it would be more consistent to override
	the configureMessageConverters method and add our converter to the list. As there can
	...
	/** Best Way
	 * This method gets invoked after all the
